...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String firstName1 = getFirstName.apply(employees.get(1));
...
//        printEmployeesByAge(employees, "Employess over 30's", employee -> employee.getAge() > 30);
//        printEmployeesByAge(employees, "\nEmployess 30 and under", employee -> employee.getAge() <= 30);
